# Norme consolidée Wikidéb’IA 1.2.31
...
> **Révision 1.2.31.** Cette révision ordonne les mots-clés par pertinence décroissante : le premier terme est le plus directement lié au sujet ou au raisonnement de la page, puis viennent les concepts progressivement moins directs. L’ordre chronologique de création, d’import ou d’ajout, ainsi que l’ordre alphabétique, ne constituent jamais des critères de classement. Les keywords anglais conservent exactement le même ordre conceptuel. La profondeur du graphe ne possède plus de cible normale, de maximum déclaré ni de seuil d’avertissement : seule la cohérence logique de chaque relation avec son parent immédiat est normative, tandis que la profondeur maximale observée reste une métrique descriptive. Toutes les autres règles 1.2.30 restent actives.
