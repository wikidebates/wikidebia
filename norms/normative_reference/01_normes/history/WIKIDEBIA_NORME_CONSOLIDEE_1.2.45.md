# Norme consolidée Wikidéb’IA 1.2.45
...
La sélection des liens est cohérente à l’échelle du passage. Lorsqu’une phrase ou un paragraphe énumère plusieurs doctrines, méthodes, phénomènes ou concepts spécialisés de même rang, la revue les examine ensemble. Si un lien explicatif est retenu pour l’un d’eux, les notions comparables disposant d’un article vérifié sont également liées, sauf justification explicite d’une différence de traitement. La revue consigne ces groupes de notions, les articles vérifiés et toute exception. Cette exigence de symétrie locale ne crée aucun quota global et n’impose pas de lier des termes courants ou déjà suffisamment expliqués hors de la série examinée.
