# Norme consolidée Wikidéb’IA 1.2.32
...
> **Révision 1.2.32.** Cette révision impose une graphie canonique des mots-clés. Les noms communs et groupes nominaux communs commencent normalement par une minuscule (`revenu`, `philosophie politique`). Une majuscule n’est admise que lorsqu’elle appartient à la graphie canonique d’un nom propre, d’une dénomination officielle, d’un sigle, d’un acronyme ou d’une marque (`Dieu`, `Union européenne`, `ONU`, `ADN`). Le vocabulaire contrôlé consigne la nature du terme, sa politique de capitalisation et, pour toute exception à la minuscule commune, une justification explicite. Deux entrées qui ne diffèrent que par la casse sont interdites. La règle s’applique symétriquement aux keywords anglais. Toutes les règles 1.2.31 restent actives.
