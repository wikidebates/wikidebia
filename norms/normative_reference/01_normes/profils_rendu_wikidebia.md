## Profil de traduction 1.2.76 — changements idiomatiques revus et preuve de risques
...
| `sujet-développé` | Objet exact du débat, sous forme non interrogative, complétant naturellement « Arguments pour et contre… » |
...
| `expanded-topic` | Non-interrogative exact object that completes “Pros and cons of…” naturally |
...
Les valeurs `sujet` et `topic` commencent par une majuscule. `sujet-développé` et `expanded-topic` complètent respectivement « Arguments pour et contre… » et « Pros and cons of… » : ils sont non interrogatifs et ne commencent pas par `si`, `whether`, `faut-il`, `should` ou une construction équivalente.
