# Wikidéb’IA — Normes 1.2.54

La révision 1.2.54 rend les normes éditoriales cumulatives : les numéros de norme et les anciens champs de révision restent des métadonnées de format, migration ou traçabilité, mais ne servent plus à activer ou désactiver les contrôles. Les règles de contenu 1.2.53, notamment la traduction anglaise par lots et la recherche documentaire des noms consacrés, restent inchangées.
