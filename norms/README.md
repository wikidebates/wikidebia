# Wikidéb’IA — Normes 1.2.52

La révision 1.2.52 impose, pour chaque argument réellement nouveau, une recherche documentaire visant à déterminer s’il possède une appellation consacrée. La règle part du principe qu’un tel nom est rare : `nom` / `name` reste absent sauf attestation solide dans la littérature.
...
- norme active : `normative_reference/01_normes/WIKIDEBIA_NORME_CONSOLIDEE_1.2.52.md` ;
- validateur recommandé : 0.4.55 ;
- kit recommandé : 2.15.29.
