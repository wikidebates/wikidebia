...
## 0.3.1 — 27 juillet 2026

- alignement sur la norme consolidée 1.1.9 ;
- nouveau contrôle `WDV-EDT-014` : avertissement heuristique sur la proximité excessive entre le titre et la première phrase ;
- nouveau contrôle `WDV-EDT-015` : attestation humaine obligatoire pour toute donnée chiffrée détectée dans un résumé 1.1.9 ;
- nouveaux champs de revue pour l’ouverture développée, la pertinence des exemples ou données, l’absence de précision artificielle et le ton ferme sans polémique ;
- compatibilité maintenue avec les paquets 1.1.0 à 1.1.8 ;
- aucune modification du graphe et aucune écriture distante.
- archivage interne des rapports et documents remplacés de la version 0.3.0.
