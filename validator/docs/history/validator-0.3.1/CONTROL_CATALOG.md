...
| `WDV-EDT-014` | Première phrase du résumé trop proche du titre ou attestation d’ouverture absente | ERROR/WARNING |
| `WDV-EDT-015` | Donnée chiffrée sans attestation documentaire humaine conforme | ERROR |
