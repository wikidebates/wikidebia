# Validateur stable Wikidéb'IA 0.2.1

Validateur local en Python 3 pour les paquets complets de débats Wikidéb'IA, aligné sur la révision normative 1.0.6 et le correctif du 23 juillet 2026. Il ne dépend pas de ChatGPT à l'exécution et ne modifie jamais les fichiers pendant une validation normale.
...
La suite contient dix-huit cas positifs et négatifs pour les schémas, graphes, cycles, titres, compteurs, wikicode, références, interlangues, lots, empreintes, transitions et recalculs.
...
- `docs/NORMATIVE_CORRECTION_2026-07-23.md` : correctif actif postérieur à la révision 1.0.6 ;
- `docs/TEST_REPORT.txt` : résultat reproductible de la suite livrée ;
- `normative_reference/` : copie des normes, décisions consolidées, catalogue d’exigences et matrice de traçabilité de Wikidéb’IA 1.0.6.
