...
def test_old_norm_metadata_does_not_disable_separator_rule():
    assert any(i.code == "WDV-DOC-007" for i in issues("Auteur A ; Auteur B", "1.2.17"))


def test_active_norm_debate_skeletons_have_nonempty_wikipedia_articles():
    from pathlib import Path
    source = Path(__file__).resolve().parents[1] / "normative_reference" / "01_normes" / "WIKIDEBIA_NORME_CONSOLIDEE_1.2.69.md"
