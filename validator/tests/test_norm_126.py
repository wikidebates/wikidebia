...
class FakeContext:
    def __init__(self):
        self.report = Report("0.4.6", "test-fixture", ["wikicode", "editorial"])

    def manifest(self):
        return {"normative_versions": {"consolidated_norm": "1.2.6"}}
...
def test_norm_126_accepts_alphabetized_sections_and_heading_fragment():
    ctx = FakeContext()
...
def test_norm_126_rejects_unsorted_sections_lowercase_topic_and_question_fragment():
    ctx = FakeContext()
...
def test_norm_126_forceful_expression_must_occur_in_summary():
    nodes = [{"id": "A0001"}]
    pages = {"A0001": {"fr"}}
