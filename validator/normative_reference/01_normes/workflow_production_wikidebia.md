...
Chaque Work reçoit un handoff vérifié, modifie uniquement les champs autorisés et livre des rapports reproductibles. Dans une reprise issue de pages existantes, les résumés et l’introduction historiques sont des champs protégés : `fr_content_review` les expose seulement comme contexte et ne peut ni les réécrire ni combler une absence historique ; une réécriture exige une opération corrective propriétaire distincte. Hors les deux checkpoints français déclarés (graphe/titres puis contenu/classification), aucune écriture distante n’est autorisée avant W11. Ces exceptions conservent un plan et un reçu signés et ne dispensent pas de la publication finale.
