# Norme consolidée Wikidéb’IA 1.2.25
...
> **Révision 1.2.25.** Cette révision sécurise la reprise distante : `manual_review` devient un blocage effectif, un plan sans opération exécutable ne peut plus produire de faux succès ni réécrire l’état publié, les archives sont traitées en staging et un dry-run ne remplace jamais le corpus actif. Elle sépare aussi explicitement le corpus installé de la sélection d’une archive. Toutes les règles 1.2.24 restent actives.
