...
PROTECTED_PAGE_PARAMETERS = {('fr', 'debate'): ('avancement', 'avertissements-titre', 'avertissements-débat', 'avertissements-bibliographie', 'avertissements-sitographie', 'avertissements-vidéographie', 'débats-connexes', 'interlangue', 'date-création'), ('en', 'debate'): ('progress', 'title-warnings', 'debate-warnings', 'related-debates', 'creation-date'), ('fr', 'argument'): ('initialisation', 'nom', 'avertissements-titre', 'avertissements-argument', 'avertissements-résumé', 'avertissements-références', 'avertissements-justifications', 'avertissements-objections', 'débat-détaillé', 'interlangue', 'date-création'), ('en', 'argument'): ('initialization', 'name', 'title-warnings', 'argument-warnings', 'summary-warnings', 'reference-warnings', 'justification-warnings', 'objection-warnings', 'detailed-debate', 'creation-date')}
