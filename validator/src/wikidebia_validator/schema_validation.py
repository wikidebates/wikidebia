...
def validate_all_schemas(ctx: PackageContext, store: SchemaStore) -> None:
    ...
    if norm in {"1.2.38", "1.2.39", "1.2.40", "1.2.41"} or quality_policy == "1.2.38" or keyword_policy == "1.2.39":
    ...
    if norm in {"1.2.38", "1.2.39", "1.2.40", "1.2.41"} or quality_policy == "1.2.38" or summary_policy in {"1.2.39", "1.2.40", "1.2.41"}:
