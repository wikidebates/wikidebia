...
def make_fixture(tmp_path: Path, *, languages=("fr",), old_pages=None, new_pages=None, migrations=None, remote_adoptions=None):
    ...
    validator.write_text("import json; print(json.dumps({'validator_version':'0.4.59','result':'passed','summary':{'errors':0,'warnings':0}}))", encoding="utf-8")
    config = {
        "kit_version":"2.15.33","project_root":str(root),"debate_id":"demo","corpus_root":"corpus/demo","languages":list(languages),
        "family":"wikidebates","pywikibot_dir":"private/pywikibot","sites":{lang:{"code":lang,"expected_user":"ChatGPT"} for lang in languages},
        "validator":{"command":[TEST_VALIDATOR_PYTHON,str(validator),"validate"],"required_version":"0.4.59","scopes":[]},
