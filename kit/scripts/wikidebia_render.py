...
KIT_VERSION = "2.15.3"
PREVIOUS_NORM_VERSION = "1.2.30"
COMPATIBLE_PREVIOUS_NORM_VERSIONS = {"1.2.27", "1.2.28", PREVIOUS_NORM_VERSION}
    ...
    *, lang: str, node: Mapping[str, Any], content: Mapping[str, Any], registry: Mapping[str, Any],
    ...
    if lang == "fr":
        ...
        params = [
            ...
            ("justifications", _relations(registry, node_id, "justification", "fr")),
            ("objections", _relations(registry, node_id, "objection", "fr")),
        ...
        params = [
            ...
            ("justifications", _relations(registry, node_id, "justification", "en")),
            ("objections", _relations(registry, node_id, "objection", "en")),
